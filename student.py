...
class Student:
    ...
    def course_schedule(self):
        response = requests.get(f"http://company.com/course-schedule/{self._last_name}/{self._first_name}") # get request to fictional api
    # check if response was successful and return response content
        if response.ok:
